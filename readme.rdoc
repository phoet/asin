...
For more information hava a look at the whole Amazon E-Commerce-API[http://docs.amazonwebservices.com/AWSEcommerceService/4-0/].

The code currently runs only on _Ruby-1.9_ due to encoding issues with the Amazon REST output (if *YOU* know how to backport this, you are welcome!).
